...
public enum HomeMenu {
    ...
    QUIT(0, "프로그램을 종료합니다!\n이용해주셔서 감사합니다~\n"),
    MAIN(1, "3.도서검색\t5.마이페이지 \t9.로그아웃\t0.프로그램 종료\n메뉴를 선택하세요: "),
    JOIN(2, "회원가입에 필요한 정보를 입력합니다.\n"),
    BOOK(3, "31.책 목록\t32.책 검색\t1.이전메뉴\t9.로그아웃\t0.프로그램 종료\n메뉴를 선택하세요: "),
    MAINMANAGER(4, "41.도서관리 \t42.추천도서관리 \t43.회원정보관리 \t9.로그아웃\t0.프로그램 종료\n메뉴를 선택하세요: "),
    BOOKMANAGE(41, "411.도서등록 \t 412.도서목록조회 \t 413.도서목록수정 \t 414.도서폐기 \t 4.이전메뉴\n메뉴를 선택하세요: "),
    BOOKADD(411, "도서등록에 필요한 정보를 입력합니다.\n"),
    BOOKSEARCH(412, "전체 책 목록\n"),
    BOOKMODIFY(413, "수정에 필요한 정보를 입력하세요."),
    RECBOOKMANAGE(42, "421.추천도서 추가\t422.추천도서 삭제\n 메뉴를 선택하세요: "),
    ...
    BOOK_SEARCH(32, "321.도서명 검색\t322.저자 검색\n메뉴를 선택하세요: "),
